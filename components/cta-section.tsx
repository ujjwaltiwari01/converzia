        ...
        >
          ...
          >
            <Button
              ...
              size="lg"
              className="w-full bg-gradient-to-r from-white via-indigo-50 to-white hover:from-indigo-50 hover:via-white hover:to-indigo-50 text-indigo-900 font-bold px-8 py-6 rounded-2xl shadow-2xl hover:shadow-white/25 transition-all duration-300 group text-lg hover:scale-102 hover:-translate-y-1"
            >
            ...
            <div className="mt-8 space-y-4">
              <p className="text-indigo-200 text-lg">
                ...
                <a
                  ...
                  className="text-white hover:text-indigo-200 transition-colors underline font-semibold"
                >
